...
| `resources.limits.cpu`                      | `string`  | Maximum CPU units for the scaler gRPC service                                                                                               | `1`                                                 |
| `resources.limits.memory`                   | `string`  | Maximum memory in bytes for the scaler service                                                                                              | `512M`                                              |
