...
| `image.tag`                                 | `string`  | Scaler gRPC service image tag (defaults to AppVersion)                                                                                      | `''`                                                |
...
| `resources.limits.cpu`                      | `string`  | Maxiumum CPU units for the scaler gRPC service                                                                                              | `1`                                                 |
| `resources.limits.memory`                   | `string`  | Maxiumum memory in bytes for the scaler service                                                                                             | `512M`                                              |
