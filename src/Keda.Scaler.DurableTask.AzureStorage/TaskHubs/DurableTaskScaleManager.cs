...
public abstract class DurableTaskScaleManager
{
    ...
    /// <param name="optionsSnapshot">The settings for the given Task Hub.</param>
    /// <param name="loggerFactory">A diagnostic logger factory.</param>
    /// <exception cref="ArgumentNullException">
    /// <paramref name="taskHub"/>, <paramref name="optionsSnapshot"/>, or <paramref name="loggerFactory"/> is <see langword="null"/>.
    /// </exception>
    ...
    protected DurableTaskScaleManager(ITaskHub taskHub, IOptionsSnapshot<TaskHubOptions> optionsSnapshot, ILoggerFactory loggerFactory)
    {
        _taskHub = taskHub ?? throw new ArgumentNullException(nameof(taskHub));
        Options = optionsSnapshot?.Get(default) ?? throw new ArgumentNullException(nameof(optionsSnapshot));
