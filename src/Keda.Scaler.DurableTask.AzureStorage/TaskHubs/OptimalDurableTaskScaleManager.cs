...
internal class OptimalDurableTaskScaleManager(ITaskHub taskHub, IOptionsSnapshot<TaskHubOptions> options, ILoggerFactory loggerFactory) : DurableTaskScaleManager(taskHub, options, loggerFactory)
{
